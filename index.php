...
<link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@200&display=swap" rel="stylesheet">
  ...
  <body dir="rtl">
   ...
   <!-- التعريف بالمسابقة -->
	 ...
	 <img src="rocket.png" />
	      <h3>عن المسابقة</h3>
	      <p>ممسابقة الشركات الناشئة 2021-2022  مسابقة  للشركات العربية الناشئة والشركات الناشئة الصغيرة. وتهدف هذه المسابقة السنوية إلى تمكين رواد الأعمال وتعزيز نظام بيئي للابتكار وريادة الأعمال في المنطقة العربية.

وتعد مسابقة منتدى الشركات الناشئة في العالم العربي، التي تنظم هذا العام تحت شعار"بناء المستقبل"، بمثابة رحلة تستمر لثلاثة أشهر مليئة بالإثارة، والتدريب، وفرص للتعارف وبناء العلاقات والتواصل، والانفتاح على وسائل الإعلام، والإرشاد، والحصول على التمويل.</p>
	  </section>
	      <?php 
