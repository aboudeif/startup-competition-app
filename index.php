...
<link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@200&display=swap" rel="stylesheet">
  ...
  <body dir="rtl">
    ...
    # التعريف بالمسابقة
      <section class="main">
	  <a href="https://www.flaticon.com/free-icons/startup" title="startup icons"><img src="rocket.png"/> Startup icons created by Freepik - Flaticon</a>
	      <h3>عن المسابقة</h3>
	      <p>ممسابقة الشركات الناشئة 2021-2022 هي تعاون بين مسابقة منتدى MIT للشركات العربية الناشئة ومسابقة منتدى MIT للشركات الناشئة في السعودية. وتهدف هذه المسابقة السنوية إلى تمكين رواد الأعمال وتعزيز نظام بيئي للابتكار وريادة الأعمال في المملكة العربية السعودية والمنطقة العربية.

وتعد مسابقة منتدى MIT للشركات الناشئة في السعودية والعالم العربي، التي تنظم هذا العام تحت شعار" نُمكّن اليوم لغد أفضل"، بمثابة رحلة تستمر لسبعة أشهر مليئة بالإثارة، والتدريب، وفرص للتعارف وبناء العلاقات والتواصل، والانفتاح على وسائل الإعلام، والإرشاد، والحصول على التمويل.</p>
	  </section>
	      <?php 
